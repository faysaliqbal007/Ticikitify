...
import { ChevronLeft, Upload, CheckCircle, LayoutDashboard, Plus, Calendar, Edit2 } from 'lucide-react';
      ...
      <div className="min-h-screen bg-dark-bg">
        ...
        <main className="pt-24 pb-16">
          <div className="max-w-md mx-auto px-4 text-center">
            ...
            >
              {isEditMode
                ? <Edit2 className="w-12 h-12 text-orange-400" />
            ...
            <p className="text-gray-400 mb-8">
              {isEditMode ? 'The event has been updated successfully.' : 'Your event is now live and visible to users.'}
            </p>
            <div className="flex gap-3">
              ...
              <Link to="/admin/events" className="flex-1">
                <Button className="w-full bg-gradient-to-r from-red-500 to-orange-500">Manage Events</Button>
              </Link>
            </div>
          </div>
        </main>
          ...
          <div className="max-w-2xl mx-auto">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} className="mb-8">
              ...
              <p className="text-gray-400">
                {isEditMode ? 'Update the event details below.' : 'Fill in the basic details to publish an event immediately.'}
              </p>
            </motion.div>
              ...
              <CardContent className="p-6">
                <form onSubmit={handleSubmit} className="space-y-6">
                  ...
                  <div>
                    ...
                    <div
                      className="mt-2 border-2 border-dashed border-white/20 rounded-xl p-8 text-center hover:border-red-500/50 transition-colors cursor-pointer"
                  ...
                  <Button
                    ...
                    className="w-full bg-gradient-to-r from-red-500 to-orange-500 text-white py-6 text-base"
                  >
                    {isSubmitting ? (
